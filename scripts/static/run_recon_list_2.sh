...
data_list=(
    "/data1/hn/gaussianSim/data/processed/static32/training/069"
    "/data1/hn/gaussianSim/data/processed/static32/training/081"
    "/data1/hn/gaussianSim/data/processed/static32/training/126"
)
...
# bash scripts/static/run_recon_list_2.sh 5